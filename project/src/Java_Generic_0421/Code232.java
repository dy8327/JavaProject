...
public class Code232 {
    public static void main(String[] args) {
        ...
        if(a.same(b)) System.out.println("a와 b는 같습니다.");
        else System.out.println("a와 b는 다릅니다.");
        if(a.same(c)) System.out.println("a와 c는 같습니다.");
        else System.out.println("a와 c는 다릅니다.");
